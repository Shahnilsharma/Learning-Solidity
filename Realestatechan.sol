...
//@author shahnil
pragma solidity ^0.8.26; //to support safemath library
...
//  //will map each attribute on with uint id
//  mapping (uint256 =>Property)public  Properties ;
//  //assigning a unique to a property
...
// // Arrays 
// // propertyIDs(stroes property ids)
// // will strore the id of each property created
